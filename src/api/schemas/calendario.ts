...
export const EventoSchema = object({
  ...
  naturaleza: optional(nullable(string())),
  fechaInicio: string(),
  fechaFin: string(),
  ...
  participantes: optional(nullable(array(string()))),
  ...
  fechaCreacion: optional(nullable(string())),
  fechaActualizacion: optional(nullable(string())),
});
