              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <div className="mt-1">
                    ...
                    {inscripcion.estadoInscripcion === EstadoInscripcion.MOVIDA_PLAN_C && (
                      <Badge className="bg-red-100 text-red-800">Migrada Plan C</Badge>
                    )}
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-orange-700 mt-1">
                        Este usuario fue migrado automáticamente el{' '}
